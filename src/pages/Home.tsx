...
function Home() {
  ...
  const scroll = () => {
    const elem = document.getElementById('skills-area')
    ...
    <div className="Home" >
      ...
      <div className="HomePage">
        <div className="ContentContainer">
          ...
          <div style={{ background: '#ff3333', height: 5, width: '50vw', marginBottom: 8 }} />
          <div className="Text1 White">Engineering Science Student | University of Toronto</div>
        ...
        <div className="Text1">I'm in my 3rd year of the University of Toronto's
        ...
        <div className="SkillsArea" id='skills-area' >
          <div className="Skill">
